...
public class Main {
    public static void main(String[] args) {
    	//"C:\Users\Usuario\eclipse-workspace\GestorCorrelativas\src\main\resources\inscripciones.csv"
        //ejecutar jar: java -jar GestorCorrelativas-1.0-SNAPSHOT.jar "C:\Users\Usuario\eclipse-workspace\GestorCorrelativas\src\main\resources\inscripciones.csv"
        ...
        //String ruta = "C:\Users\Usuario\eclipse-workspace\GestorCorrelativas\src\main\resources/inscripciones.csv";
        ...
        for (Inscripcion inscripcion : inscripciones) {inscripcion.aprobada();
        	System.out.println(inscripcion.getAlumno().getNombre() + ", Materia: " + inscripcion.getMateria().getNombre() + ", Fecha Inscripcion: " + inscripcion.getFecha() + ", puede cursar: " + inscripcion.estadoDeInscripcion());
        }
