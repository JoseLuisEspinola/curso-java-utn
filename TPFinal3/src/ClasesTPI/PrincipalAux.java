	...
	public static void main(String[] args) {
		...
		// Guardo datos de RESULTADO - deberia ser una clase
  		try {
			...
			// RESULTADO
			ArrayList<String[]> equipoResultado = new ArrayList<String[]>();
			for(int i = 0; i < listaResultado.size(); i++) {
				equipoResultado.add(listaResultado.get(i).split(","));
				//System.out.println(Arrays.toString(equipoResultado.get(i)));
				//System.out.println(equipoResultado.get(i));
						//.toString(equipoResultado.get(i)));
			}
			
			
			ArrayList<String[]> equipoPronostico = new ArrayList<String[]>();
			for(int i = 0; i < listaPronostico.size(); i++) {
				equipoPronostico.add(listaPronostico.get(i).split(","));
				//System.out.println(equipoPronostico);
			}
