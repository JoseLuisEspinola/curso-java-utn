...
public class Inicio {
	...
	public static void main(String[] args) {
		...
		try {
			...
			desPorcentajeConTope.setValorDesc(0.40f);
			
			float resultado = miCarrito.costoFinal(desFijo);   // por la linea siguiente que empieza con el float
			
			
			//float resultado = persona1.getCarrito().costoFinal();  // esta sola linea, reemplaza a las 2 anteriores
			System.out.println("SUBTOTAL carrito: $" + (producto1.costoFinal() + producto2.costoFinal() + producto3.costoFinal()));
			System.out.println(" ");
			
			System.out.println("DESCUENTO Carrito: $" + ((producto1.costoFinal() + producto2.costoFinal() + producto3.costoFinal()) - resultado));
			System.out.println(" ");
			
			System.out.println("TOTAL a pagar Carrito: $" + resultado);
			System.out.println(" ");
