...
public class Inicio {
	...
	public static void main(String[] args) {
		...
		try {
			...
			float resultado = miCarrito.costoFinal();   // por la linea siguiente que empieza con el float
			...
			System.out.println("La persona que hizo la compra es " + persona1.getNombre() + " " + persona1.getApellido() + ", y tiene " + persona1.edad() + " años");
